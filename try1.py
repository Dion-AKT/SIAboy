...
# (Dilengkapi styling warna sederhana)
# =============================================================
...
# === Simple CSS styling (warna) ===
st.markdown(
    """
    <style>
    /* Halaman & background */
    .stApp {
        background-color: #004d3dff;
    }

    /* Sidebar */
    [data-testid="stSidebar"] {
        background-color: #8D9A6C;
        color: #ffffff;
    }

    /* Judul, teks, label */
    h1, h2, h3, h4, h5, h6, p, label, .css-1dl0z2k, .css-1v3fvcr {
    ...
    .stDataFrame table th {
        background-color: rgba(141,154,108,0.15) !important;
        color: #FFFFFF !important;
    ...
    /* Download button small tweak */
    button[kind="primary"] {
        background-color: #8D9A6C !important;
        color: #fff !important;
    }

    /* Make sure sidebar headers look good */
