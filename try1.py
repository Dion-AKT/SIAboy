# =============================================================
# Aplikasi Siklus Akuntansi Dagang — Final UI (Dark Green + Sidebar Hijau Muda)
...
st.markdown(
    ...
    /* App background (dark-green) */
    .stApp {
        background-color: #004d3dff; /* dark green */
    }

    /* Sidebar: light olive */
    [data-testid="stSidebar"] {
        background-color: #8D9A6C; /* sidebar green */
        color: #fff;
        padding-top: 22px;
    }

    /* Round logo in sidebar */
    .sidebar-logo {
        border-radius: 16px;
    ...
    /* Ensure headings and text are white */
    ...
    .stDataFrame table th {
        background-color: rgba(141,154,108,0.18) !important; /* slightly lighter header */
        color: #FFFFFF !important;
        border-bottom: 1px solid rgba(255,255,255,0.08) !important;
        font-weight: 600;
    }
    .stDataFrame table td {
        background-color: rgba(0,77,61,0.0) !important;
        color: #FFFFFF !important;
        border-bottom: 1px solid rgba(255,255,255,0.03) !important;
    }

    /* Inputs: make text white and background slightly translucent */
    input, textarea, .stTextInput>div>div, .stNumberInput>div>div, .stDateInput>div>div {
        color: #FFFFFF !important;
        background-color: rgba(255,255,255,0.03) !important;
    }
    /* Placeholder text a bit dimmer (works in many browsers) */
    input::placeholder {
    ...
    .stButton>button, button[kind="primary"] {
        background-color: #8D9A6C !important;
        color: #fff !important;
    ...
    .stExpander > div[data-testid="stExpanderHeader"] {
        background-color: rgba(141,154,108,0.12);
        color: #FFFFFF;
        border-radius: 8px;
        padding: 8px 12px;
        margin-bottom: 8px;
    ...
    /* Make sure sidebar headings are visible */
    .stSidebar .css-1v3fvcr, .stSidebar .css-1d391kg {
        color: #fff !important;
    }

    /* Small tweaks to make the download button icon visible */
...
with st.sidebar:
    if os.path.exists("logo.jpg"):
        st.image("logo.jpg", width=160, use_column_width=False, output_format="auto", caption=None, clamp=False, channels="RGB", format="JPEG", )  # image will be rounded by CSS border-radius
    st.markdown("## Sistem Akuntansi Dagang")
    st.markdown("---")
...
def main_app():
    ...
    output = io.BytesIO()
    # Try xlsxwriter first, fallback to openpyxl if not available
    try:
